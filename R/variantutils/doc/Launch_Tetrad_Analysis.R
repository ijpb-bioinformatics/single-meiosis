...
#
# Lecture du fichier de config ou positionnement des variables
#

# Path to the tetrad

#TetradPath <- "/projects/Single_Meiosis/Tetrades_Versailles/ParentsAndF1"
TetradPath <- "/projects/Single_Meiosis/Tetrades_Fifa/wtfifa/wtfifa_merged"
...
# Variant 
# GoldVariantPath <- "/projects/Single_Meiosis/Ressources/Ler0/Variant_All" 
# sdiFilePath <- "/projects/Single_Meiosis/Ressources/Ler0/Variant_All/newsdi.txt"
# ColPositionFilePathPref <- "/projects/Single_Meiosis/Ressources/Ler0/Variant_All/dfColPos"
# LerPositionFilePathPref <- "/projects/Single_Meiosis/Ressources/Ler0/Variant_All/dfLerPos"

GoldVariantPath <- "/projects/Single_Meiosis/Ressources/Ler0/Gold_Variant_475129" 
sdiFilePath <- "/projects/Single_Meiosis/Ressources/Ler0/Gold_Variant_475129/newsdi.txt"
ColPositionFilePathPref <- "/projects/Single_Meiosis/Ressources/Ler0/Gold_Variant_475129/dfColPos"
LerPositionFilePathPref <- "/projects/Single_Meiosis/Ressources/Ler0/Gold_Variant_475129/dfLerPos"

# Nom de l'analyse
AnalysisName="AnalyseNewGenotypeFunction_1"
...
if(! file.exists(paste(TetradPath,"Analysis",basename(GoldVariantPath),AnalysisName,"CO",sep="/" ))){
...
if(! file.exists(paste(TetradPath,"Analysis",basename(GoldVariantPath),AnalysisName,"VCF_tetrad",sep="/"))){
...
if(! file.exists(paste(TetradPath,"Analysis",basename(GoldVariantPath),AnalysisName,"NCO",sep="/" ))){
...
if(! file.exists(paste(TetradPath,"Analysis",basename(GoldVariantPath),AnalysisName,"REPORT",sep="/"))){
...
if(! file.exists(paste(TetradPath,"Analysis",basename(GoldVariantPath),AnalysisName,"Plot",sep="/"))){
