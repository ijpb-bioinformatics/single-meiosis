...
# R Script to process one Tetrad
# merge Col and Ler chromosome position count files 
# with the Col/Ler syntheny file 
# call CO (CrossOver.py programm from )
# prepare input for hmm-nco detection 
# input: 
#    -output of single-meiosis_pipeline.sh
# output:  
#   -Analysis
#       |_Gold_Variant
#            |_InputHMM
...
sourceDir("/r-dev/variantutils/R")
